...
from flask_login import LoginManager # flask_login makes it easy to manage user sessions to allow them to log in and log out
...
login_manager.login_view = "login" # When we use login_required decorator for account route, this tells extension where our login route is located. Here, we give function name of our route (what we pass to url_for function)
login_manager.login_message_category = "info" # blue info alert to make it not look ugly
