...
for num in range(100):
    first = random.choice(first_names) # Pick 1 random one
    last = random.choice(last_names)

    phone = f'{random.randint(100, 999)}-555-{random.randint(1000,9999)}' # randint gets a random integer from a to b inclusive
